            ...
            <div class="ulogo">
                <a href="{{route('index')}}">
                    ...
                    <div class="d-flex align-items-center justify-content-center">
                        <img src="{{asset('backend/images/AbelLogo.png')}}" alt="Logo"
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if(Auth::user()->usertype == "Admin" || Auth::user()->usertype == "employee")
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('student.class.view') }}"><i class="ti-more"></i>Class</a></li>
                        <li><a href="{{ route('student.year.view') }}"><i class="ti-more"></i>Academic Year</a></li>
                        <li><a href="{{ route('student.group.view') }}"><i class="ti-more"></i>Faculty</a></li>
                        <li><a href="{{ route('student.shift.view') }}"><i class="ti-more"></i>Shift</a></li>
                        ...
                        <li><a href="{{ route('exam.type.view') }}"><i class="ti-more"></i>Examination</a></li>
                        <li><a href="{{ route('school.subject.view') }}"><i class="ti-more"></i>Courses</a></li>
                        <li><a href="{{ route('assign.subject.view') }}"><i class="ti-more"></i>Assign Subject
                                Grades</a>
                        </li>
                        <li><a href="{{ route('designation.view') }}"><i class="ti-more"></i>Role Designation </a></li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'marks.entry.add')?'active':'' }}"><a
                                href="{{ route('marks.entry.add') }}"><i class="ti-more"></i>Assign Grades</a></li>
                        <li class="{{ ($route == 'marks.entry.edit')?'active':'' }}"><a
                                href="{{ route('marks.entry.edit') }}"><i class="ti-more"></i>Edit Grades</a></li>

                        <li class="{{ ($route == 'marks.entry.grade')?'active':'' }}"><a
                                href="{{ route('marks.entry.grade') }}"><i class="ti-more"></i>Grade System Information</a>
                        </li>
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'other.cost.view')?'active':'' }}"><a
                                href="{{ route('other.cost.view') }}"><i class="ti-more"></i>Miscellaneous</a></li>
...
{{--                        </li>--}}
                    ...
                    <li class="{{ ($route == 'marksheet.generate.view')?'active':'' }}"><a
                            href="{{ route('marksheet.generate.view') }}"><i class="ti-more"></i>Generate Result</a>
                    </li>
