...
<table id="customers">
    <tr>
        <td><h2>
                <?php $image_path = '/upload/AbelLogo.png'; ?>
                <img src="{{ public_path() . $image_path }}" width="100" height="70">

            </h2></td>


        <td><h2>LMS</h2>
            <p>Athlone Institute of Technology (AIT)</p>
            <p>Phone : 0852334609</p>
            <p>Email : a00288615@student.ait.ie</p>
