                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <h5>Mothers Maiden Name <span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <select name="religion" id="religion" required class="form-control">
                                                                ...
                                                                <option value="Hinduism" {{ ($editData['student']['religion'] == 'Hinduism')? 'selected':'' }}>Hindu</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <img id="showImage" src="{{ (!empty($editData['student']['image']))? url('upload/student_images/'.$editData['student']['image']):url('upload/no_image.jpg') }}" style="width: 100px; border: 1px solid black;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
