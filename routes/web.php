...
Route::get('/activation{code}', [ActivationController::class, 'activation'])->name('user.activation');
Route::get('/resend/code', [ActivationController::class, 'coderesend'])->name('code.resend');
Route::get('/activation{code}', [ActivationController::class, 'activation'])->name('user.activation');


// Public controller route for guests
...
Route::group(['middleware' => 'auth'],function(){
    //post route
    Route::get('/posts/new', [PostController::class, 'newPost'])->name('newPost');
    Route::post('/posts/new', [PostController::class, 'createPost'])->name('createPost');

    //Comments route
    Route::post('new-comment', [CommentController::class, 'newComment'])->name('newComment');

    Route::get('products', [AdminController::class, 'products'])->name('products');
    Route::get('products/new', [AdminController::class, 'addNewProduct'])->name('NewProducts');
    Route::post('products/new', [AdminController::class, 'storeNewProduct'])->name('addProducts');
    Route::get('products/{id}', [AdminController::class, 'editProduct'])->name('editProducts');
    Route::post('products/{id}', [AdminController::class, 'updateProduct'])->name('updateProducts');
    Route::get('products/{id}/delete', [AdminController::class, 'deleteProduct'])->name('deleteProducts');
...
//
    Route::prefix('shop')->group(function (){
        ...
        Route::get('product/{id}/execute', [ShopController::class, 'executeOrder'])->name('shop.executeOrder');
    });
